...
CollisionCell& CollisionGrid::GetCellAtPosition(base::Vector2 position)
{
...
void CollisionGrid::Add(std::unique_ptr<GameObject> object, CollisionObjectType type)
{
	...
	auto position = base::Vector2{ bBox.left, bBox.top };
...
void CollisionGrid::Move(GameObject& object, base::Vector2 distance)
{
