...
Body::SweptAABBResult Body::SweptAABB(RectF movingRect, base::Vector2 distance, RectF staticRect)
{
	// Broad-phase test 
	...
	if (distance.x == base::Vector2::Zero().x && distance.y == base::Vector2::Zero().y) // TODO:
		return SweptAABBResult::Empty();

	auto entryDistance = base::Vector2{};
	auto exitDistance = base::Vector2{};
...
Body::BroadPhase Body::CreateBroadPhase(RectF rect, base::Vector2 distance)
{
