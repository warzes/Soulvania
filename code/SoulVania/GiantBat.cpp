...
void GiantBat::Dive(base::Vector2 playerPosition)
{
...
void GiantBat::Shoot(std::unique_ptr<RangedWeapon> fireball, base::Vector2 destination)
{
	auto fireballPosition = GetOriginPosition();
	auto direction = base::Vector2::Normalize(destination - fireballPosition);
